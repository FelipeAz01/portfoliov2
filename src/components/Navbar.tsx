      ...
      <div className="relative font-medium">
        <button className="menu-btn md:hidden" onClick={toggleMenu}>
          <FontAwesomeIcon
            ...
            className="text-[24px] place-self-center"
          />
        </button>
        <nav className={`navbar${isMenuOpen ? " active" : ""}`}>
          <ul className="flex flex-col md:flex-row gap-10 items-center">
            <li>
              <a
                href="#projects"
                className="hover:text-text-gray transition-colors cursor-pointer"
              >
                {t("projects")}
              </a>
            </li>
          ...
          <ul className="flex gap-5 items-center">
            ...
            <li
              className="cursor-pointer hover:saturate-0 transition-all"
              onClick={toggleLanguage}
            >
              <Image
                src={pathname.startsWith("/pt") ? brasilFlag : usaFlag}
                alt="Flag"
