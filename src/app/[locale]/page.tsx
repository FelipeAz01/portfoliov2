    ...
    <>
      ...
      <main className="max-w-[1440px] mx-auto overflow-hidden lg:overflow-visible">
        <section className="px-4 max-w-[1440px] relative mx-auto overflow-hidden lg:overflow-visible">
          ...
          <div className="bg-[#87e075] spotlight h-[550px] -top-96 right-32 sm:right-80 lg:right-[410px] animate-spotlight2 animation-delay-2000"></div>
          <div className="bg-[#45a552c7] spotlight h-[500px] -top-32 right-24 sm:right-56 lg:right-[350px] animate-spotlight"></div>
          <div className="bg-[#20d67e] spotlight h-[575px] -top-56 -right-12 sm:right-0 lg:right-32 animate-spotlight animation-delay-1000"></div>
        ...
        >
          ...
          <div>
            ...
            >
              ...
              {aboutTitle?.[2]}
              <span className="text-text">criar experiências digitais.</span>
            </motion.h2>
            <motion.p
        ...
        >
          {/* Spotlight Effect Elements */}
          <div className="bg-[#87e075] spotlight-bottom h-[550px] -bottom-[400px] right-24 sm:right-80 lg:left-[550px] animate-spotlight-bottom2 animation-delay-2000"></div>
          <div className="bg-[#45a552c7] spotlight-bottom h-[500px] -bottom-60 right-14 sm:right-56 lg:left-[700px] animate-spotlight-bottom"></div>
          <div className="bg-[#20d67e] spotlight-bottom h-[575px] -bottom-72 -right-16 sm:right-0 lg:left-[930px] animation-delay-1000 animate-spotlight-bottom"></div>
          ...
          <div className="grid gap-32">
            ...
            <footer className="flex justify-between flex-col-reverse min-[520px]:flex-row items-center gap-5">
              ...
              <div className="flex gap-5">
                <a href="https://github.com/FelipeAz01" target="_blank">
                  <FontAwesomeIcon icon={faGithub} className="navbar-icon" />
                </a>
                <a
                  href="https://www.linkedin.com/in/felipeadonda/"
                  target="_blank"
                >
